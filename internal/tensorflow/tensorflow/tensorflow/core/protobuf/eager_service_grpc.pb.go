...
// All implementations should embed UnimplementedEagerServiceServer
...
// UnimplementedEagerServiceServer should be embedded to have forward compatible implementations.
