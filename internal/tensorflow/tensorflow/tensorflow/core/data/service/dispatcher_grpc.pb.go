...
type DispatcherServiceClient interface {
	...
	DisableCompressionAtRuntime(ctx context.Context, in *DisableCompressionAtRuntimeRequest, opts ...grpc.CallOption) (*DisableCompressionAtRuntimeResponse, error)
}
...
func (c *dispatcherServiceClient) Snapshot(ctx context.Context, in *SnapshotRequest, opts ...grpc.CallOption) (*SnapshotResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tensorflow.data.DispatcherService/Snapshot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dispatcherServiceClient) GetSnapshotSplit(ctx context.Context, in *GetSnapshotSplitRequest, opts ...grpc.CallOption) (*GetSnapshotSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tensorflow.data.DispatcherService/GetSnapshotSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dispatcherServiceClient) GetSnapshotStreams(ctx context.Context, in *GetSnapshotStreamsRequest, opts ...grpc.CallOption) (*GetSnapshotStreamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tensorflow.data.DispatcherService/GetSnapshotStreams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dispatcherServiceClient) DisableCompressionAtRuntime(ctx context.Context, in *DisableCompressionAtRuntimeRequest, opts ...grpc.CallOption) (*DisableCompressionAtRuntimeResponse, error) {
	out := new(DisableCompressionAtRuntimeResponse)
	err := c.cc.Invoke(ctx, "/tensorflow.data.DispatcherService/DisableCompressionAtRuntime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedDispatcherServiceServer
...
type DispatcherServiceServer interface {
	...
	// Returns information about the decision to disable compression at runtime
	// for the given dataset.
	DisableCompressionAtRuntime(context.Context, *DisableCompressionAtRuntimeRequest) (*DisableCompressionAtRuntimeResponse, error)
}

// UnimplementedDispatcherServiceServer should be embedded to have forward compatible implementations.
...
func (UnimplementedDispatcherServiceServer) DisableCompressionAtRuntime(context.Context, *DisableCompressionAtRuntimeRequest) (*DisableCompressionAtRuntimeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisableCompressionAtRuntime not implemented")
}
...
func _DispatcherService_Snapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tensorflow.data.DispatcherService/Snapshot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DispatcherService_GetSnapshotSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tensorflow.data.DispatcherService/GetSnapshotSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DispatcherService_GetSnapshotStreams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tensorflow.data.DispatcherService/GetSnapshotStreams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DispatcherService_DisableCompressionAtRuntime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisableCompressionAtRuntimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DispatcherServiceServer).DisableCompressionAtRuntime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tensorflow.data.DispatcherService/DisableCompressionAtRuntime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispatcherServiceServer).DisableCompressionAtRuntime(ctx, req.(*DisableCompressionAtRuntimeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DispatcherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DisableCompressionAtRuntime",
			Handler:    _DispatcherService_DisableCompressionAtRuntime_Handler,
		},
	},
