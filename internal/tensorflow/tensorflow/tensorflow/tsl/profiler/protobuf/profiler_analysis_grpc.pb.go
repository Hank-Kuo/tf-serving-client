...
// All implementations should embed UnimplementedProfileAnalysisServer
...
// UnimplementedProfileAnalysisServer should be embedded to have forward compatible implementations.
