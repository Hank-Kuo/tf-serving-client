...
// All implementations should embed UnimplementedCloudTpuDriverServer
...
// UnimplementedCloudTpuDriverServer should be embedded to have forward compatible implementations.
