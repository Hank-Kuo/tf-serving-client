...
// All implementations should embed UnimplementedXlaServiceServer
...
// UnimplementedXlaServiceServer should be embedded to have forward compatible implementations.
